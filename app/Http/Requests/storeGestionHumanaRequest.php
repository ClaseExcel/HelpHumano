...
class storeGestionHumanaRequest extends FormRequest
{
    /**
    ...
    {
        return Gate::allows('CREAR_GESTIÓN_HUMANA');
    }
    ...
    public function rules()
    {
        return [
            'empresa_id' => 'required',
            'cedula' => 'required',
            'cedula' => 'required|unique:gestion_humana,cedula|between:6,10',
            'nombres' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'cedula.unique'  => 'Se encontró un empleado registrado con el mismo número de cédula.',
