            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="row">
                            @if(Auth::user()->id != 1)
                            <input type="hidden" name="empleado_cliente_id" id="empleado_cliente_id" value="{{ $usuario_cliente->id }}">
                            @endif
                ...
                <div class="modal-footer bg-transparent border-0">
                    <button class="btn btn-save" onclick="crearCita()">Crear cita</button>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header  bg-help">
                    ...
                    <span class="modal-title display-6 fs-3" id="titulo-actividad"> Información</span>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
