...
@section('title', 'Informe capacitaciones especificas por usuario')
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-8">
            <div class="card">
                <div class="card-header fs-5">
                    Informe de capacitaciones especificas por usuario
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="ta" role="tabpanel" aria-labelledby="ta-tab">
                            <form method="GET" action="{{ route('admin.excel-actividades') }}" id="actividadesTipo">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="form-floating mb-3">
                                            <select
                                                class="form-select {{ $errors->has('tipo_actividad_id') ? 'is-invalid' : '' }}"
                                    ...
                                    @include('admin.informes.includes.fields-actividades')
                        ...
                        <div class="tab-pane fade" id="estado" role="tabpanel" aria-labelledby="estado-tab">
                            <form method="GET" action="{{ route('admin.excel-actividades-estado') }}"
        ...
        <div class="col-12 col-md-4">
            <div class="card">
                <div class="card-header fs-5">
                    Generar reporte capacitación
                </div>

                <div class="card-body">
                    <form method="GET" action="{{ route('admin.pdf-actividades') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" id="actividad_id" name="actividad_id" class="form-control"
                                    placeholder=" " required />
                                <label for="actividad_id" class="fw-normal">&nbsp; # Capacitación</label>
                                @error('actividad_id')
                                    <span id="actividad_id" class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
