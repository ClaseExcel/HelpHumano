...
<body>
    <table>
        <thead>
            <tr>
                <th></th>
                <th style="font-weight:bold; font-size:12px;">Informe de actividades especificas por empresas</th>
            </tr>
        </thead>
        <tbody>
            <tr>
    ...
    <table>
        <thead>
            <tr>
                <th
                style="background-color: #48A1E0; color: #FFFFFF;  border: #080000 1px solid;  text-align: center; border: solid #080000 10px; width:100px">
                # Actividad</th>
                <th
                style="background-color: #48A1E0; color: #FFFFFF;  border: #080000 1px solid;  text-align: center; border: solid #080000 10px;">
                Nombre de la actividad</th>
