...
<body>
    ...
    <div class="content" style="text-align:center;">
        <h2 style="color:#48A1E0;">¡Se solicito un requerimiento!</h2>
        <p style="color:#616161;">Te notificamos que se ha solicitado el requerimiento <b>{{ $tipo_requerimiento }}</b> con consecutivo <b>{{ $consecutivo }}</b> de la empresa <b>{{ $empresa }}</b>
            a solicitud del empleado <b>{{ $empleado }}</b> para que se de su respectiva revisión</p>
